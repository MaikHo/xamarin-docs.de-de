...
ms.locfileid: "87426863"
---
# <a name="no-locxamarinforms-local-databases"></a>Xamarin.FormsLokale Datenbanken
...
## <a name="access-data-in-no-locxamarinforms"></a>Datenzugriff inXamarin.Forms
...
Diese Eigenschaft ermöglicht es Xamarin.Forms Komponenten, Datenabruf-und Bearbeitungsmethoden für die- `Database` Instanz als Reaktion auf eine Benutzerinteraktion aufzurufen. Zum Beispiel:
