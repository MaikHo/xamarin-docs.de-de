...
![Linkeroptionen für Xamarin.iOS](memory-perf-best-practices-images/linker-options-ios.png)

Der folgende Screenshot zeigt die Linkeroptionen in Visual Studio für Mac für ein Xamarin.Android-Projekt:

![Linkeroptionen für Xamarin.Android](memory-perf-best-practices-images/linker-options-droid.png)
